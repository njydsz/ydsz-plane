...
-- ============================================================================
-- 迁移脚本整合：0001_pages_category_versions_links.up.sql
-- 页面模块增强：category 字段、版本历史、文档关联表
-- ============================================================================

-- pages 表添加 category 字段
...
-- ============================================================================
-- 迁移脚本整合：0002_pages_templates_shares.up.sql
-- 文档模块增强：文档模板与公开分享链接表
-- ============================================================================
...
COMMENT ON COLUMN page_templates.content_html IS '模板的富文本 HTML 内容';
...
-- 内置模板（workspace_id=0, project_id=0 表示全局内置；id 由序列自动生成）
-- 注意：以下 INSERT 依赖 workspace_id=0 和 user_id=0 作为"系统级"标识
...
(0, 0, '复盘模板', '项目复盘结构：回顾目标、评估结果、分析原因、总结行动',
 '<h2>回顾目标</h2><p>当初的目标是什么？</p><h2>二、评估结果</h2><p>实际达成的结果与偏差。</p><h2>三、分析原因</h2><p>成功因素与失败根因。</p><h2>四、行动计划</h2><ol><li>继续保持：...</li><li>开始做：...</li><li>停止做：...</li></ol>',
 'review', 0);


-- ============================================================================
-- 迁移脚本整合：0003_dashboard_widget_types.up.sql
-- 仪表盘布局增强：扩展 widget 类型约束
-- ============================================================================

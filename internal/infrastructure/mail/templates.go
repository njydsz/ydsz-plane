...
import "github.com/njydsz/ydsz-plane/pkg/strutil"
...
func RenderResetPassword(d ResetPasswordData) Message {
	...
	text := "您好 " + d.RecipientName + ",\r\n\r\n" +
		...
		d.ResetURL + "\r\n\r\n" +
		"链接将在 " + strutil.FastItoa(d.TTLMin) + " 分钟后过期。如非本人操作请忽略此邮件。\r\n\r\n" +
		"— Ydsz Plane 团队"
	html := `<p>您好 ` + d.RecipientName + `，</p>` +
		...
		`<p style="color:#999;font-size:12px">链接将在 ` + strutil.FastItoa(d.TTLMin) + ` 分钟后过期。如非本人操作请忽略此邮件。</p>` +
		`<p>— Ydsz Plane 团队</p>`

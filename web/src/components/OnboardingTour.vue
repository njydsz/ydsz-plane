...
const steps: Step[] = [
  ...
  {
    title: "第一步：创建您的第一个项目",
    subtitle: "项目是需求/任务/缺陷的容器。建议按产品或团队维度创建，如「移动端 App」「后端服务」。",
    icon: "📁",
    action: "创建项目",
  },
  {
title: "第二步：创建第一个需求/任务/缺陷",
subtitle: "在看板或列表页点击「+ 创建需求/任务/缺陷」。您可以选择需求、任务或缺陷类型来启动工作流。",
    icon: "📋",
    action: "了解看板",
  },
  {

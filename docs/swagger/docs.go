...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_interfaces_http.forgotPasswordRequest"
                        }
                    }
                ],
                "responses": {
                    "202": {
                        "description": "已接受（不一定实际存在该邮箱）"
                    },
                    "422": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_interfaces_http.loginRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_interfaces_http.refreshRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_interfaces_http.registerRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_interfaces_http.resetPasswordRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "internal_interfaces_http.forgotPasswordRequest": {
            "type": "object",
            "required": [
                "email"
            ],
        ...
        "internal_interfaces_http.loginRequest": {
            "type": "object",
            "properties": {
                "email": {
                    "type": "string",
        ...
        "internal_interfaces_http.refreshRequest": {
            "type": "object",
            "properties": {
                "refresh_token": {
                    "type": "string"
        ...
        "internal_interfaces_http.registerRequest": {
            "type": "object",
            "properties": {
                "display_name": {
                    "type": "string",
        ...
        "internal_interfaces_http.resetPasswordRequest": {
            "type": "object",
            "required": [
                "new_password",
                "token"
